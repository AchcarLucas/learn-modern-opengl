...
inline std::vector<Vertex> ex_16_quad_vertices = {
...
inline std::vector<Vertex> ex_16_floor_vertices = {
...
inline std::vector<GLuint> ex_16_indices = {
    0, 1, 3,
    1, 2, 3
};

inline std::vector<GLuint> ex_16_quad_indices = {
    3, 1, 0,
    3, 2, 1
};

inline std::vector<Vertex> ex_16_cube_vertices = {
    // Back face
...
inline std::vector<GLuint> ex_16_cube_indices = {
    0, 1, 2,
    5, 4, 3,
...
int run_016(const int width, const int height)
{
