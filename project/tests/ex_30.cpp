...
inline std::vector<Vertex> ex_30_quad_vertices = {
...
inline std::vector<GLuint> ex_30_quad_indices = {
    3, 1, 0,
    3, 2, 1
};

int run_030(const int width, const int height)
{
    float _WIDTH = width;
    ...
    Shader *shader_floor = new Shader("glsl/ex_30/floor.vs", "glsl/ex_30/floor.fs");
    Shader *shader_screen = new Shader("glsl/ex_30/anti_aliasing.vs", "glsl/ex_30/anti_aliasing.fs");
    Shader *shader_light = new Shader("glsl/ex_30/light.vs", "glsl/ex_30/light.fs");
