...
static void loadScene(GLFWwindow* window, const int width, const int height)
{
    ...
    shader_object = new Shader("glsl/ex_45/model_loading.vs", "glsl/ex_45/model_loading.fs");
    shader_deferred = new Shader("glsl/ex_45/deferred_shading.vs", "glsl/ex_45/deferred_shading.fs");
