...
int run_040(const int width, const int height)
{
    ...
    Shader *shader_screen = new Shader("glsl/ex_40/posprocessing.vs", "glsl/ex_40/posprocessing.fs");
    Shader *shader_floor = new Shader("glsl/ex_40/floor.vs", "glsl/ex_40/floor.fs");
    Shader *shader_light = new Shader("glsl/ex_40/light.vs", "glsl/ex_40/light.fs");
