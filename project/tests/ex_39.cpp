...
int run_039(const int width, const int height)
{
    _stbi_set_flip_vertically_on_load(true);

    Shader *shader_text = new Shader("glsl/text_sdf/text_sdf.vs", "glsl/text_sdf/text_sdf.fs");

    RenderText *render_text_screen = new RenderText("fonts/arial.ttf", width, height, 0, 48, TextType::DRAW_TO_SCREEN, true);
    RenderText *render_text_world = new RenderText("fonts/arial.ttf", width, height, 0, 48, TextType::DRAW_TO_WORLD, true);
