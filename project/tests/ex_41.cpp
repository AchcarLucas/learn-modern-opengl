...
// camera class
static Camera *camera = new Camera(glm::vec3(0, 0, 10), glm::vec3(0, 0, 0));
...
int run_041(const int width, const int height)
{
    float _WIDTH = width;
    ...
    Shader *shader_screen = new Shader("glsl/ex_41/posprocessing.vs", "glsl/ex_41/posprocessing.fs");
    Shader *shader_floor = new Shader("glsl/ex_41/floor.vs", "glsl/ex_41/floor.fs");
    Shader *shader_light = new Shader("glsl/ex_41/light.vs", "glsl/ex_41/light.fs");
    ...
    */
    ...
    Texture2D *texture_brick = new Texture2D("./resources/textures/wood.png", TextureType::DIFFUSE, true, GL_SRGB);
    Texture2D *texture_brick_normal = new Texture2D("./resources/textures/toy_box_normal.png", TextureType::NORMAL, true, GL_SRGB);
    Texture2D *texture_brick_displacement = new Texture2D("./resources/textures/toy_box_disp.png", TextureType::DISPLACEMENT, true, GL_SRGB);
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        // global lights
        {
            ...
            shader_floor->setFloat("height_scale", height_scale);
        ...
        // screen text render
        {
            ...
            render_text_screen->draw(shader_text,
                string("Press '+' or '-' to ") + to_string(height_scale) + string(" Height Scale"),
                500.0f, 410.0f, 0.5f,
                glm::vec3(0.5, 0.8f, 0.2f));
        }
...
static void processInput(GLFWwindow *window, float delta_time)
{
    ...
    if(waiting_time > 0.2f) {
        ...
        if (glfwGetKey(window, GLFW_KEY_KP_ADD) == GLFW_PRESS)
        {
            ...
            glm::clamp(height_scale, 0.0f, 1.0f);
        }
